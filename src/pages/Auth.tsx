        ...
        <div className="p-8 md:p-12 flex flex-col justify-center order-1 md:order-2">
          {showResetPassword ? (
            ...
            <div className="space-y-5">
              ...
              <button
                type="button"
                className="w-full h-14 font-semibold text-base shadow-lg rounded-lg transition-all duration-200 flex items-center justify-center hover:shadow-xl hover:scale-[1.02]"
                style={{ 
                  backgroundColor: '#1A3E5C',
                  color: 'white',
                }}
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0F2840'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#1A3E5C'}
